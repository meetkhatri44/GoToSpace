...
<head>
    ...
    <title>GoToWorkspace | Add Task</title>
...
<body>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Task Name</label> <input type="text" name="catname" value="" class="form-control" required='true'> </div>
