...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   echo '<script>alert("Task name has been updated")</script>';
  
}
else
{

echo "<script>alert('Task Name Already Exist. Please try again');</script>";
}
}
?>
...
<head>
    ...
    <title>GoToWorkspace | Update Task</title>
...
{               ?>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Task Name</label> <input type="text" name="catname" value="<?php  echo $row->CategoryName;?>" class="form-control" required='true'> </div>
