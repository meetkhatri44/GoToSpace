...
<head>
    ...
    <title>GoToWorkspace | Edit Member</title>
...
<div class="form-group"> <label for="exampleInputEmail1">Member Added Date</label> <input type="text" value="<?php  echo $row->PasscreationDate;?>" class="form-control" readonly='true'> </div>
<?php $cnt=$cnt+1;}} ?> 
