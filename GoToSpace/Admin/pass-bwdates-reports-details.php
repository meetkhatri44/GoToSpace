...
<head>
    ...
    <title>GoToWorkspace | Member Report Details</title>
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Between Dates Reports of Member</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
...
?>
<h5 align="center" style="color:blue">Member Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
