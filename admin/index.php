...
<head>
    ...
    <title>GoToWorkspace | Login Page</title>
...
<body style="background-color: rgb(144, 236, 192)" class="body-Login-back">

    <div class="container">
       
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center logo-margin ">
            <h3 style="color: black; font-size: 48px;">GoToWorkspace</h3>
                </div>
